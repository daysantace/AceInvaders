...
## Installation
As of present, Ace Invaders must be built with Godot directly.

### System requirements
These are not properly tested but rather calculated by measuring utilisation from HTop and doing fancy maths. It's probably inaccurate.<br>
<br>
* RAM - 64 MB
...
<br>
Git can also be installed on virtually every CLI package manager, like apt, dnf, brew, or scoop.
#### Godot
[Install](https://godotengine.org/download)<br>
(note that it may redirect to the wrong platform, just replace the platform in the url with your platform)<br>
...
Translations can be done in Godot directly, through the Localisations tab in Project settings.
...
Ace Invaders is developed in GDScript, Godot's scripting language. Use that for programming.<br>
